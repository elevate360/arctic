...
function arctic_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'arctic_content_width', 640 );
}
add_action( 'after_setup_theme', 'arctic_content_width', 0 );
...
function arctic_scripts() {
	...
	wp_enqueue_script( 'arctic-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'arctic-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
