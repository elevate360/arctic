 ...
 */
function arctic_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function arctic_sanitize_css( $css ) {
 ...
 */
function arctic_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function arctic_sanitize_email( $email, $setting ) {
 ...
 */
function arctic_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function arctic_sanitize_html( $html ) {
 ...
 */
function arctic_sanitize_image( $image, $setting ) {
 ...
 */
function arctic_sanitize_nohtml( $nohtml ) {
 ...
 */
function arctic_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function arctic_sanitize_number_range( $number, $setting ) {
 ...
 */
function arctic_sanitize_select( $input, $setting ) {
 ...
 */
function arctic_sanitize_url( $url ) {
